...
> The documentation site for [wsk-notify](http://github.com/bloomberg/wsk-notify): https://bloomberg.github.io/wsk-notify
...
This repository contains the code used to generate the documentation for wsk-notify](http://github.com/bloomberg/wsk-notify). It also serves as an example repository for how to build out a complete wsk project. It uses the following technologies
...
2. One addition is manually added to the `input-README.md` file: the following line is added to the bottom of the `## Installaion` section `**[See wsk-notify's source code on GitHub](https://github.com/bloomberg/wsk-notify)**`.
